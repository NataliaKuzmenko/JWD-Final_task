...
public class UserDaoImpl implements UserDao {
    ...
    private static final String GET_USER_BY_ID = "SELECT user_id,email,first_name,last_name,role_id,photo_path " +
            "FROM users WHERE user_id=?";
    private static final String ADD_STUDENT_APPLY_ON_COURSE = "INSERT INTO lists_students (user_id, course_run_id) " +
            "VALUES (?, ?)";
