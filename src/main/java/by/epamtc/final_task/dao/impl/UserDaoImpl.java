...
public class UserDaoImpl implements UserDao {
    ...
    private static final String UPDATE_USER = "UPDATE users SET first_name=?, last_name=?,photo_path=?,email=? WHERE user_id=?";
    ...
    @Override
    public boolean addUserOnCourse(long studentId, long courseId) throws DaoException {
        boolean result = false;
        try (Connection connection = ConnectionPool.getInstance().getConnection();
