...
public final class PageName {
    ...
    public static final String EDIT_COURSE = "/WEB-INF/jsp/courses/edit_course.jsp";
    public static final String ERROR_PAGE = "/WEB-INF/jsp/error.jsp";
    public static final String INDEX_PAGE = "/index.jsp";
    public static final String LECTURER_COURSES_PAGE = "/WEB-INF/jsp/user/lecturer_courses.jsp";
    ...
    public static final String SET_USER_RESULT_PAGE = "/WEB-INF/jsp/courses/set_user_result.jsp";
